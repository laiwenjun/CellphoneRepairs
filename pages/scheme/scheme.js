...
Page({
  ...
  formSubmit: function(a) {
    ...
    if (72 == d.repairWay) {
      ...
      var l = new Date().getFullYear(),
        u = d.timeStr.split("月")[0].replace(/(明天|今天)/gi, ""),
        m = d.timeStr.split("月")[1].split("日")[0],
        p = d.timeStr.split("日")[1];
    ...
    if (n) {
      ...
      var g = c.data.data.isColor,
        _ = c.data.data.color_name,
        w = "";
      if (g && _) {
  ...
  exchange_fun: t.throttle(1e3, function() {
    ...
    if (i) {
      ...
      for (var n = !0, c = 0, d = i.length; c < d; c++)
        if (20 === i[c].choose_failure) {
          n = !1;
          break;
        }
  ...
  showTimeDetaile: function(a) {
    var e = this.data.time_list,
      ...
      r = parseInt(t.sm_star_minute),
      s = parseInt(t.sm_end_hour),
      i = parseInt(t.sm_end_minute),
      n = parseInt(60),
      c = 60 * o + r,
      d = 60 * s + i,
      l = c;
