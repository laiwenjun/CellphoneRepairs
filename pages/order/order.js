...
Page({
  ...
  onReachBottom: function() {
    ...
    var rspOrder = onfire.on('rspOrder', function(msg) {
      ...
      //     }
      //   });
      // } else if (0 == rsp.length && 0 != a.length) wx.showToast({
      //   title: "没有更多订单了",
      //   icon: "success",
      //   duration: 2e3,
      //   mask: !0
