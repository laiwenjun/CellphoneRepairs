  ...
  onLoad: function(r) {
    ...
    try {
      var s = wx.getStorageSync("Allbrandmodel"),
        i = wx.getStorageSync("AllFault"); //所有故障
...
//       });
  ...
  pipei: function() {
    ...
    try {
      ...
      var r = [];
      for (var n in e)
        if (e[n].smallModelName) {
          r = e[n].smallModelName.split(";");
          for (var s in r)
            if (r[s] == l || r[s] == l.split("<")[0] || r[s] == l.split("(")[0]) {
              var i = e[n].brandID,
                d = "",
                c = e[n].modelID,
                u = e[n].color_name,
  ...
  clickFailure: function(a) {
    var t = this,
      e = a.target.dataset.choose_failure,
      l = a.target.dataset.detail_index || "0";
  ...
  click_fault_details: function(a) {
    var t = a.target.dataset.index,
      e = this.data.faultDetailArr;
    if (e[t].class) e[t].class = null;
    else {
  ...
  delSelectedFault: function(a) {
    ...
    if (t && t.length)
      for (var e in t) t[e].choose_failure == a && (console.log(t[e]),
  ...
  bottom_price: function() {
    var a = this.data.selectedFaults,
      t = 0;
    if (a && a.length)
      for (var e in a) t += parseFloat(a[e].price);
    this.setData({
      bottom_price: t
    });
  },
  click_phoneImg: function() {
    var a = this,
      t = this.data.guzhang_status ? "" : "on",
      e = this.data.number_px;
  ...
  refreshBottomHeight: function() {
    var a = this.data.selectedFaults.length,
      t = 116 * (a + 0);
    0 != a ? this.setData({
      number_px: t
    }) : this.setData({
  ...
  nextFun: function() {
    ...
    var t = a.data.dataForm,
      e = a.data.selectedFaults,
      o = t;
  ...
  show_selModel: function() {
    var a = this,
      e = wx.getStorageSync("sel_modelInfo"),
      o = void 0;
    if (e && t && t.length) {
